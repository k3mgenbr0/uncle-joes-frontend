...
export function normalizeMember(payload) {
  ...
  return {
    ...
    currentPoints: record.current_points ?? null,
    lifetimePoints: record.lifetime_points ?? null,
    ...
    currentTierMinPoints: record.current_tier_min_points ?? null,
    nextTierMinPoints: record.next_tier_min_points ?? null,
    nextRewardThreshold: record.next_reward_threshold ?? null,
    currentRewardProgress: record.current_reward_progress ?? null,
